...
return [
    ...
    */
    ...
    'project_logo'   => '<span class="text-white"><span class="bg-white text-dark font-weight-bold rounded">Pro</span>поиск</span>',
    ...
    'sidebar_class' => 'sidebar bg-white sidebar-pills shadow-sm',
    ...
    'developer_name' => 'Alux web-studio design',
    ...
    */
    ...
    'authentication_column_name' => 'Телефон номер',
